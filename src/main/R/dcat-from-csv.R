...
write.csv(collapse_df_on_pipe(df),"../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-chemische_stof/catalog.csv", row.names = FALSE)
...
system(paste("riot --formatted=TURTLE ", tmp_file, " > ../resources/be/vlaanderen/omgeving/data/id/dataset/codelijst-chemische_stof/catalog.ttl"))
